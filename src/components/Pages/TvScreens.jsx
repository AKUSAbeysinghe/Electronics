...
const TVsAndDisplays = () => {
  ...
  const SUBCATEGORY_IDS = {
    ...
    MONITORS: 17,
    Projectors: 18, 
    DigitalDisplaysSignage: 19,
    TVAccessoriesMounts: 20,
  };
    ...
    try {
      ...
      if (data.success && Array.isArray(data.data)) {
        const tvItems = data.data.filter(
          item => Number(item.category_id) === 4
        );
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-wrap justify-between items-center gap-4">
            <div className="flex items-center gap-2 text-sm flex-wrap">
              ...
              <button
                onClick={() => setActiveFilter(SUBCATEGORY_IDS.MONITORS)}
                className={`px-5 py-2.5 rounded-full transition-all ${
                  activeFilter === SUBCATEGORY_IDS.MONITORS ? "bg-[#4d61fc] text-white" : "bg-[#0a0f1c] text-gray-400 hover:text-white"
                }`}
              >
                Monitors
              </button>
              ...
              <button
                onClick={() => setActiveFilter(SUBCATEGORY_IDS.Projectors)}
                className={`px-5 py-2.5 rounded-full transition-all ${
                  activeFilter === SUBCATEGORY_IDS.Projectors ? "bg-[#4d61fc] text-white" : "bg-[#0a0f1c] text-gray-400 hover:text-white"
                }`}
              >
                Projectors
              </button>
              ...
              <button
                onClick={() => setActiveFilter(SUBCATEGORY_IDS.DigitalDisplaysSignage)}
                className={`px-5 py-2.5 rounded-full transition-all ${
                  activeFilter === SUBCATEGORY_IDS.DigitalDisplaysSignage ? "bg-[#4d61fc] text-white" : "bg-[#0a0f1c] text-gray-400 hover:text-white"
                }`}
              >
              ...
              <button
                onClick={() => setActiveFilter(SUBCATEGORY_IDS.TVAccessoriesMounts)}
                className={`px-5 py-2.5 rounded-full transition-all ${
                  activeFilter === SUBCATEGORY_IDS.TVAccessoriesMounts ? "bg-[#4d61fc] text-white" : "bg-[#0a0f1c] text-gray-400 hover:text-white"
                }`}
              >
