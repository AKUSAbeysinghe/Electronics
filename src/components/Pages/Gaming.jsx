...
const GamingPage = () => {
  ...
  const WHATSAPP_NUMBER = '94771234567'; // Consistent with all other pages
  ...
  // WhatsApp Message Function (Consistent with other pages)
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-wrap justify-between items-center gap-4">
            <div className="flex items-center gap-2 text-sm flex-wrap">
              ...
              <button
                onClick={() => setActiveFilter(SUBCATEGORY_IDS.Peripherals)}
                className={`px-5 py-2.5 rounded-full transition-all ${
                  activeFilter === SUBCATEGORY_IDS.Peripherals ? "bg-[#4d61fc] text-white" : "bg-[#0a0f1c] text-gray-400 hover:text-white"
                }`}
              >
                Peripherals
              </button>
              ...
              <button
                onClick={() => setActiveFilter(SUBCATEGORY_IDS.Software)}
                className={`px-5 py-2.5 rounded-full transition-all ${
                  activeFilter === SUBCATEGORY_IDS.Software ? "bg-[#4d61fc] text-white" : "bg-[#0a0f1c] text-gray-400 hover:text-white"
                }`}
              >
                Games & Software
              </button>
                ...
                {filteredGaming.map((item) => (
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      {/* WhatsApp Button - Consistent Style */}
                      <button
